...
fun uniffi_mopro_example_app_fn_func_generate_noir_proof(`circuitPath`: RustBuffer.ByValue,`srsPath`: RustBuffer.ByValue,`inputs`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
...
fun uniffi_mopro_example_app_fn_func_verify_noir_proof(`circuitPath`: RustBuffer.ByValue,`proof`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): Byte
...
public object FfiConverterMapStringSequenceString: FfiConverterRustBuffer<Map<kotlin.String, List<kotlin.String>>> {
    ...
    @Throws(MoproException::class) fun `generateNoirProof`(`circuitPath`: kotlin.String, `srsPath`: kotlin.String?, `inputs`: List<kotlin.String>): kotlin.ByteArray {
            return FfiConverterByteArray.lift(
    uniffiRustCallWithError(MoproException) { _status ->
    UniffiLib.INSTANCE.uniffi_mopro_example_app_fn_func_generate_noir_proof(
        FfiConverterString.lower(`circuitPath`),FfiConverterOptionalString.lower(`srsPath`),FfiConverterSequenceString.lower(`inputs`),_status)
}
    )
    }
    ...
    @Throws(MoproException::class) fun `verifyNoirProof`(`circuitPath`: kotlin.String, `proof`: kotlin.ByteArray): kotlin.Boolean {
            return FfiConverterBoolean.lift(
    uniffiRustCallWithError(MoproException) { _status ->
    UniffiLib.INSTANCE.uniffi_mopro_example_app_fn_func_verify_noir_proof(
        FfiConverterString.lower(`circuitPath`),FfiConverterByteArray.lower(`proof`),_status)
}
    )
    }
