...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeGroth16ProofResult: FfiConverterCircomRustBuffer {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeGroth16ProofResult_lift(_ buf: CircomRustBuffer) throws -> Groth16ProofResult {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeGroth16ProofResult_lower(_ value: Groth16ProofResult) -> CircomRustBuffer {
...
public func generateGroth16Proof(zkeyPath: String, circuitInputs: String, proofLib: CircomProofLib)throws  -> Groth16ProofResult  {
    return try  FfiConverterTypeGroth16ProofResult_lift(try rustCallWithError(FfiConverterTypeCircomMoproError_lift) {
...
public func verifyGroth16Proof(zkeyPath: String, proofResult: Groth16ProofResult, proofLib: CircomProofLib)throws  -> Bool  {
